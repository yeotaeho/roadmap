...
> 전체 구현은 `backend/domain/master/hub/services/collectors/economic/wowtale/wowtale_collector.py` 를 직접 참고하세요. 아래는 노이즈 필터·source_type 분류·KST 변환·`content:encoded` 우선 추출 4가지 핵심 패턴만 발췌했습니다.
...
async def ingest_wowtale(self, *, max_items: int = 50) -> dict[str, Any]:
    """Wowtale RSS 피드 수집."""
    from domain.master.hub.services.collectors.economic.wowtale.wowtale_collector import (
