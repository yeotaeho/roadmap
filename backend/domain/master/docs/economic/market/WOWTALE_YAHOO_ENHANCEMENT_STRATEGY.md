...
```python
# backend/domain/master/hub/services/collectors/economic/wowtale/wowtale_archive_crawler.py (신규)
...
**구현**:
```python
# backend/domain/master/hub/services/collectors/economic/platum/platum_collector.py (신규)
