...
from domain.master.hub.services.collectors.economic.common._doc_parsers import (
    parse_document,
)
            ...
            async def process_row(
                ...
                async with sem:
                    ...
                    try:
                        ...
                        logger.exception(
                            "[%s] attachment parse failed path=%s",
                            BOARD_KEY,
                            local_path,
                        )
                        ...
                        try:
                            ...
                            logger.warning(
                                "[%s] temporary attachment cleanup failed path=%s",
                                BOARD_KEY,
                                local_path,
                            )
